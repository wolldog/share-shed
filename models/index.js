...
Product.belongsTo(User, {
  foreignKey: { name: "owner_id", allowNull: false, onDelete: "CASCADE" },
});
...
Booking.belongsTo(User, {
  foreignKey: { name: "customer_id", allowNull: false, onDelete: "RESTRICT" },
});

//Booking has one product
Booking.belongsTo(Product, {
  foreignKey: { allowNull: false, onDelete: "RESTRICT" },
});
